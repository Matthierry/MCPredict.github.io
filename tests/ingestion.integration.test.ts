...
function sourceRow(overrides: Partial<Record<keyof typeof SOURCE_INDEXES, string>> = {}) {
  ...
  const values: Record<string, string> = {
    ...
    homeTeam: "Arsenal",
    awayTeam: "Leeds",
    matchBookmakerHomeProbability: "1.72",
    matchBookmakerDrawProbability: "4.00",
    matchBookmakerAwayProbability: "4.76",
    ouBookmakerOverProbability: "1.62",
    ouBookmakerUnderProbability: "2.33",
    matchEdge: "10.3%",
    ouEdge: "10.2%",
